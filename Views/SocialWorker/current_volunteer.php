            ...
            <div class="col-lg-8">
                ...
                switch ($sort) {
                    ...
                    case 'nearest':
                        ...
                        break;
                    default:
                        $sql_base .= " ORDER BY vp.vol_proj_id DESC";
                        break;
                }
                ...
                if (mysqli_num_rows($req3) == 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($req3)) {
                        ...
                        // PENDING BADGE
                        $query = "SELECT COUNT(*) AS pending_count FROM tbl_volunteers WHERE vol_proj_id = '".$row['vol_proj_id']."' AND stat = 'pending'";
                            ...
                            <div class="card mb-3" style="max-width: 730px;">
                                <div class="row no-gutters position-relative">
                                    <div class="col-md-5 mb-md-0">
                                        <img class="card-img" src="vol_img/' . $row['image'] . '">
                                    </div>
                                    <div class="col-md-7 position-static p-4 pl-md-0">
                                        <div class="card-body">
                                            ...
                                            <a href="volunteer-details.php?id=' . $row['vol_proj_id'] . '" class="stretched-link"></a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <form method="GET" action="">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="completed">Pending</label>
                            </div>
                        </div>
                        ...
                        <a href="current_volunteer.php" style="font-size: 14px; color: #777; font-style: italic; text-align: right;">Clear Filters</a><br><br>
