...
<!-- TITLE BARS -->
<div class="header">
        <h5>ASSISTANCE PROJECT DETAILS</h5>
    </div>
  ...
  <div class="profile-image">
    ...
    <section class="home-section">
        ...
        // Query to retrieve assistance details
        $sql = "SELECT * FROM tbl_assistance
                RIGHT JOIN tbl_sw_accs ON tbl_assistance.sw_id = tbl_sw_accs.sw_id
                WHERE tbl_assistance.assistance_id = '$id'";
        $result = mysqli_query($conn, $sql);

        $sql4 = "SELECT * FROM tbl_sw_accs WHERE sw_id = '$sw_id'";
        ...
        // Query to count the number of verified assistance beneficiaries
        ...
        $sql3 = "SELECT DISTINCT appli_id FROM tbl_applicants WHERE assistance_id = $id AND stat = 'Pending'";
        $mysqliStatus = $conn->query($sql3);
        $assist_applicant = mysqli_num_rows($mysqliStatus);
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <div class="container w-75">
                <div class="title text-center">
                    ...
                    <h3><a href="/assistance_projects.php?id=<?php echo $id; ?>" target="_blank"><?php echo $row['title']; ?></a></h3>
            ...
            <div class="container info w-50 text-center">
                <div class="row mb-4">
                    <div class="col-6">
                        <div class="box">
                            <div class="row">
                                <p class="title"> Beneficiaries Needed </p>
                            </div>
                            <div class="row">
                                <p class="data"><?php echo $row['avail_slot']; ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="box">
                            <div class="row">
                                <p class="title"> Verified Beneficiaries </p>
                            </div>
                            <div class="row">
                                <p class="data"><?php echo $assistance_count; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-6">
                        <div class="box">
                            ...
                            <div class="row">
                                <p class="data"><?php echo $assist_applicant; ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="box">
                            ...
                            <div class="row">
                                <p class="data"> <?php echo date('F j, Y', strtotime($row['deadline'])); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container data w-75">
                <div class="row">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                          ...
                          <div class="tab-pane fade show active" id="pills-graph" role="tabpanel" aria-labelledby="pills-graph-tab" tabindex="0">
                            <div class="graph-box">
                              ...
                              <div>
                                <?php if ($assistance_count >= $row['avail_slot']) { ?>
                                    <p class="progress-text">Goal Reached!</p>
                                    <?php } else { ?>
                                    <p class="progress-text"><?php echo number_format($assistance_count); ?> beneficiaries <br> <?php echo number_format($remaining); ?> to go</p>
                                <?php } ?>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="col-4">
                        <div class="row mb-2">
                            <div class="div-btn">
                                <a href="view-assistance.php?id=<?php echo $row['assistance_id']; ?>"><button class="btn" type="button"> View Assistance Applicants </button></a>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="div-btn">
...
<?php if ($project_stat === 'ON GOING' || $project_stat === 'PAST DUE'): ?>
    <!-- SEND ASSISTANCE APPLICATION UPDATE -->
    <div class="row mb-2">
        <div class="div-btn">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#appliEmailModal" data-projectid="<?php echo $id; ?>">Send Application Update</button>
        </div>
    </div>
<?php endif; ?>

<!-- Email modal for Application Update -->
<div class="modal fade" id="appliEmailModal" tabindex="-1" aria-labelledby="appliEmailModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="send_appli_updates_assist.php" method="post">

                <div class="mb-3">
                        <label for="subject" class="form-label"><b>Subject</b></label>
                        <input type="text" class="form-control" name="subject" id="subject" required value="Assistance Application Update">
                    </div>
                   ...
                   <input type="hidden" name="assistance_id" id="assistance_id" value="<?php echo $id; ?>">
    ...
    $(document).ready(function() {
        $('#status').change(function() {
            ...
            if (selectedStatus === 'Verified') {
                messageField.val("Good Day! You are now a beneficiary for the project: "+ projectTitle + ". The QR Code is now available at your designated DORA Account. See you soon!");
            } else if (selectedStatus === 'Invalid') {
                messageField.val("Good Day. Your application for project: "+ projectTitle + " has been marked as Invalid.\n\nYou can visit our website for more information.");
            } else {
...
<!-- SEND ASSISTANCE PROJECT UPDATE -->
<?php if ($project_stat === 'ON GOING' || $project_stat === 'PAST DUE'): ?>
<div class="row mb-2">
    <div class="com-btn">
...
<!-- Email modal for Project Update -->
<div class="modal fade" id="projectEmailModal" tabindex="-1" aria-labelledby="projectEmailModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="send_project_updates_assist.php" method="post">
                    <!-- Input for the email subject with a predefined value -->
                    <div class="mb-3">
                        <label for="subject" class="form-label"><b>Subject</b></label>
                        <input type="text" class="form-control" name="subject" id="subject" required value="Assistance Project Update">
                    </div>

                    <div class="mb-3">
            <label for="message2" class="form-label"><b>Message</b></label>
            <textarea class="form-control" name="message2" id="message2" rows="6" required><?php
                echo "Hello Assistance Project Beneficiaries, as our project '$projectTitle' day is approaching, we want to make sure everything goes smoothly. Please be on time, and having your QR Codes ready will help us check you in quickly. Your presence is important, and we're excited about a successful day of teamwork. Thanks for your dedication to this project and for being part of this meaningful effort.";
            ?></textarea>
        </div>
    ...
    <?php 
        $sql_assistance = "SELECT * FROM tbl_assistance where assistance_id = $id AND sw_id = $sw_id";
        $assist = mysqli_query($conn, $sql_assistance);
                        
        while ($fetch_assist = mysqli_fetch_array($assist)){
        $title = $fetch_assist['title'];
        $image = $fetch_assist['image'];
        $deadline = $fetch_assist['deadline'];
        $text = $fetch_assist['text'];
        $avail_slot = $fetch_assist['avail_slot'];
        $location = $fetch_assist['location'];
        }
    ?>
    ...
    <?php
        if (isset($_POST['save_changes'])) {
            ...
            $newdeadline = mysqli_real_escape_string($conn, $_POST['deadline']);
            $newtext = mysqli_real_escape_string($conn, $_POST['text']);
            $newavail_slot = mysqli_real_escape_string($conn, $_POST['avail_slot']);
            ...
            if ($newImageProvided) {
                ...
                $target = "assist_img/" . basename($newImageName);
            ...
            $sqlUpdate = "UPDATE tbl_assistance SET
            title = '$newtitle',
            image = '$newImageName',
            deadline = '$newdeadline',
            text = '$newtext',
            avail_slot = '$newavail_slot',
            location = '$newlocation'
            WHERE assistance_id = $id AND sw_id = $sw_id";
            ...
            if ($queryUpdate) {
                ...
                echo 'Swal.fire({
                        ...
                        window.location.href = "assistance-details.php?id=' . $id . '";
                    });';
                echo '</script>';
            } else {
                echo '<script>';
    ...
    <!-- Modal for Editing Assistance Details -->
    <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit your assistance details</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data">
    
                        <label for="title">Title of the assistance:</label>
                        <input type="text" name="title" class="form-control" value="<?php echo htmlspecialchars($title); ?>" required><br>
    
                        <input type="hidden" name="size" value="1000000">
                        <label for="image">Assistance Image</label>
                        ...
                        <label for="avail_slot">Available Slot:</label>
                        <input type="number" class="form-control" name="avail_slot" value="<?php echo htmlspecialchars($avail_slot); ?>" min="10" max="80" step="1" required><br>
    
                        <label for="location">Location:</label>
                        <input type="text" class="form-control" name="location" value="<?php echo htmlspecialchars($location); ?>" required><br>
                        
                        <label for="deadline">Deadline: </label>
                        <input type="date" class="form-control" id="deadline" name="deadline" value="<?php echo htmlspecialchars($deadline); ?>" required min="<?php echo date('Y-m-d'); ?>"><br>
    ...
    <?php
      ...
      if (isset($_POST['proj_complete'])) {
          ...
          if ($stmt->execute()) {
              ...
              // Update proj_stat to 'COMPLETED' in tbl_assistance
              $update_proj_stat_query = "UPDATE tbl_assistance SET proj_stat = 'COMPLETED' WHERE assistance_id = ?";
              $stmt = $conn->prepare($update_proj_stat_query);
              $stmt->bind_param("i", $project_id);
              $stmt->execute();
          
              // Redirect to assistance-details.php with project_ID as a query parameter
              echo '<script>';
              echo 'Swal.fire({
                      title: "Project Mark as Completed!",
                      icon: "success",
                    }).then(function() {
                        window.location.href = "assistance-details.php?id=' . $project_id . '";
                    });';
              echo '</script>';
          } else {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p> This final report will let the applicants know the turnout of the project. <p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>This post is to update applicants about your project. You can share any additional information.<p>
    ...
    <div class="modal fade" id="UploadModal" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Upload images to gallery for the applicants to see. <p>
                    <form method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
  ...
  <script>
      ...
      var myPieChart = new Chart(ctx, {
          ...
          data: {
              ...
              datasets: [{
                  label: 'Amount',
                  data: [<?php echo $assistance_count; ?>, <?php echo $remaining; ?>],
                  backgroundColor: [
                      'rgba(255, 99, 132, 0.6)',
                      'rgba(54, 162, 235, 0.6)'
                  ],
...
<!-- Populate Application Update Modal -->
<script>
    document.addEventListener("DOMContentLoaded", function () {
        var appliEmailModal = document.getElementById("appliEmailModal");
        appliEmailModal.addEventListener("show.bs.modal", function (event) {
            var button = event.relatedTarget; 
            var projectID = button.getAttribute("data-projectid"); 
            document.getElementById('assistance_id_appli').value = projectID; 
        });
    });
</script>

<!-- Populate Project Update Modal -->
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        projectEmailModal.addEventListener("show.bs.modal", function (event) {
            var button = event.relatedTarget; 
            var projectID = button.getAttribute("data-projectid"); 
            document.getElementById('assistance_id_project').value = projectID; 
        });
    });
</script>
