...
<body>
    ...
    <?php
       $id = $_GET['id'];
        $sql = "SELECT tbl_don_proj.*, tbl_sw_accs.*, tbl_don_proj.image AS don_proj_image
        FROM tbl_don_proj
        ...
        <div class="container w-75 content">
            <div class="row">
                <div class="col-lg-8">
                   <div class="proj-img">
    <?php
    $imagePath = '../SocialWorker/don_img/' . $row['don_proj_image'];
                ...
                <div class="col-4">
                    <div class="box">
                        ...
                        if ($donation !== null && is_numeric($donation)) {
                            ...
                            $formattedDonation = number_format($donation);
                            echo '<p class="progress-raised">&#8369; ' . $formattedDonation . ' raised </p>';
                        } else {
                            // Handle the case where $donation is null or not a numeric value
                            echo '<p class="progress-raised">&#8369; 0</p>';
                        }
                        ?>
                        ...
                        <p class = "progress-to-go">&#8369; '.number_format($remaining).' to go </p> ';} ?>
                    </div>
                    ...
                    <div class="donate-box">
                        ...
                        <form action="donate_now.php?id=<?php echo $id; ?>" method="post">
                            <div class="row">
                                <?php if ($remaining >= 50) { ?>
                                <div class="col-6">
                            ...
                            <div class="donate-now-other">
                                <div class="row align-items-center">
                                    <?php if ($remaining <= 3000) { ?>
                                    <div class="col-7">
                                        <input type="number" min="50" max="<?php echo $remaining?>" name="custom_amount" id="customAmount" class="custom-input" value="<?php echo $remaining?>" />
                                    </div>
                                    <?php } else { ?>
                                    <div class="col-7">
                                        <input type="number" min="50" max="<?php echo $remaining?>" name="custom_amount" id="customAmount" class="custom-input" placeholder="Other Amount" />
                                    </div>
                                    <?php } ?>
                                    <div class="col-5">
