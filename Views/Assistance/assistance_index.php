        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption bottom-0 mb-5">
                ...
                <p class="mt-5 fs-5">Get information on ongoin donation drives</p>
                <a href="#" class="btn btn-outline-light px-4 py-2 fs-7 mt-4">Learn More</a>
            </div>
          </div>
          <div class="carousel-item">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption bottom-0 mb-5">
                ...
                <p class="mt-5 fs-5">Browse and apply to different assistance programs provided by DSWD</p>
                <a href="#" class="btn btn-outline-light px-4 py-2 fs-7 mt-4">Learn More</a>
            </div>
          </div>
        </div>
