...
<body>
    ...
    <?php
        // QUERY TO KNOW THE NUMBER OF BENEFICIARIES
 ...
 <br> Date Uploaded: <?php echo date('F j, Y', strtotime($row['uploadDate'])); ?> </p> 
        ...
        <div class="container w-75 content">
            <div class="row">
                <div class="col-lg-8">
                    <div class="proj-img">
    <?php
    $imagePath = '../SocialWorker/assist_img/' . $row['assistance_image']; // Use the alias here
    ...
    ?>
                        ...
                        <div class="tab-pane fade show active" id="pills-about" role="tabpanel" aria-labelledby="pills-about-tab" tabindex="0">
                            <div class="proj-desc">
                                ...
                                <div class="additional">
                                    ...
                                    <p>Location: <b><?php echo $row['location']; ?></p></b>
                ...
                <div class="col-4">
                   <div class = "box">
                        <p class = "progress-raised"> <?php echo $assist_count; ?> registered volunteers</p>   
                    ...
                    <div class="donate-now">
                            <a href = assist_appform.php?id=<?php echo $id; ?>><button class="btn-don">Apply Now</button></a>
                    </div>
