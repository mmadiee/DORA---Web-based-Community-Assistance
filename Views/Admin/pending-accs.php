        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="all-tab-pane" role="tabpanel" aria-labelledby="all-tab" tabindex="0">
                <table class="table">
                    ...
                    <?php
                    $sql4 = "SELECT *, CONCAT(fname, ' ', COALESCE(mname, ''), ' ', lname) AS full_name, CONCAT(street, ', Brgy. ', brgy, ', ', municipality, ', ', city ) 
                            AS location FROM tbl_sw_accs WHERE status = 'pending' LIMIT $start_from, $records_per_page";
                    ...
                    while ($row = mysqli_fetch_array($result2)) {
                        echo '
                                    <tr>
                                        ...
                                        <td>' . $row['location'] . '</td>';
                        echo '<td><a href="pending-details.php?sw_id=' . $row['sw_id'] . '"><button type="button" class="btn btn-info">Details</button></a></td>
                                    </tr>';
                    }
                    ?>
                    </tbody>
                ...
                <ul class="pagination">
                    ...
                    $total_records_query = "SELECT COUNT(*) as total FROM tbl_sw_accs WHERE status = 'pending'";
