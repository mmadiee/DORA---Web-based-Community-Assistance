    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            ...
            <div class="form-group mb-3">
                <input class="form-control" type="number" min="0" name="otp" placeholder="Enter code" required>
            </div>
            <div class="form-group text-center mb-3">
                <button type="submit" name="check-reset-otp" class="btn btn-primary w-25">Submit</button>
            </div>
            </form>
        </div>
    </div>
