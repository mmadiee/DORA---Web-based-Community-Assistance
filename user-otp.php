...
// Assuming acc-verify.php sets a flag in the session upon successful verification
...
<!--NAV BAR-->
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <form action="user-otp.php?acctype=<?php echo $acctype ?>" method="POST">
            <div class="form-group mb-3">
                <input type="number" name= "otp" min="1" class="form-control" placeholder="Enter verification code" required>
            </div>
