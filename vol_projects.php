...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/vol-projects.css">
...
<style><?php include 'Views\SocialWorker\css\vol-fullproject.css'; ?></style>
    ...
    <div class="container w-75 content">
        <div class="row">
            <div class="col-lg-8">
                <div class="proj-img">
    <?php
    $imagePath = 'Views/SocialWorker/vol_img/' . $row['project_image']; // Use the alias here
    ...
    ?>
            ...
            <div class="col-4">
                ...
                <div class="donate-now">
                    <a href="login.php"><button class="btn-don">Register Now</button></a>
                </div>
            </div>
        </div>
    </div>
